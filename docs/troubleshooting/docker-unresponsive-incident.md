...
The Pi 2B has 1GB of RAM. Memory pressure and swap usage likely caused Docker to enter an inconsistent state — containers alive on paper, but not actually functional. Internal networking or port binding may have silently broken under resource exhaustion.
